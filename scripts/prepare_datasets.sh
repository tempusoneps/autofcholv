...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      ...
      echo "Automatically prepare OHLCV (CSV) and Features (Parquet) datasets inside datasets/ directory."
      echo ""
      echo "Options:"
...
# 2. Check & Generate FEATURE_DATASET (Parquet directly via autofcholv)
